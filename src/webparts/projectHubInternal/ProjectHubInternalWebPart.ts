...
export default class ProjectHubInternalWebPart extends BaseClientSideWebPart<IProjectHubInternalWebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<IProjectHubInternalProps> =
      React.createElement(ProjectHubInternal, {
