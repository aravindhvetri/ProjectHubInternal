...
export default class ProjectHubInternal extends React.Component<IProjectHubInternalProps, {}> {
  public render(): React.ReactElement<IProjectHubInternalProps> {
    ...
    return (
      <section className={`${styles.projectHubInternal} ${hasTeamsContext ? styles.teams : ''}`}>
