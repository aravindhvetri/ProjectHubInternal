    ...
    <>
      {loader ? (
        ...
        >
          ...
          >
            <div className={projectFormStyles.fieldWraps}>
                  ...
                  >
                    ...
                    <InputText
                      ...
                      onChange={(e) => {
                        ...
                        handleOnChange("CompletionPercentage", onlyNumbers);
                      }}
                  ...
                  >
                    ...
                    <Dropdown
                      value={initialCRMBillingsListDropContainer?.BillingFrequency.find(
                        (item: any) => item.name === formData?.BillingFrequency,
                      )}
                      onChange={(e) =>
